...
from .views import (
    ...
    ClientAccessUpdateView,
    ClientSignalView,
    MarkPaidView,
    MasterBulkActionView,
...
urlpatterns = [
    ...
    path("appointments/bulk-action/", MasterBulkActionView.as_view(), name="appointments-bulk-action"),
    path("appointments/<int:appointment_id>/", AppointmentDetailView.as_view(), name="appointments-detail"),
    path("appointments/<int:appointment_id>/client-access/", ClientAccessUpdateView.as_view(), name="appointments-client-access"),
